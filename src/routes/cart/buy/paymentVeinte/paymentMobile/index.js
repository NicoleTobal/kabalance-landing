...
function PaymentMobile(props, {doPaymentMobile}) {
    ...
    return (props.show) // Show the Payment Mobile Form
            ? (
            ...
            : (props.loading) // Show Loading of request
                ...
                : (props.error) ? (<h6>Error: {props.error}</h6>) // Show errors if ocurrs an exception
                : (
                    <div className="container">
                        <h6>Pago Movil efectuado</h6>
                    </div>
